        ...
        <div className="container md:flex md:flex-col py-8">
            ...
            <div className="flex mx-auto flex-col md:flex-row gap-15 items-center md:items-start md:pb-8 md:px-30">
                ...
                <div className="md:text-left md:w-3/5 hidden md:flex md:flex-col md:gap-4 pl-15 my-auto text-xl font-medium">
                    <p>
                        Je travaille avec{" "}
                        <span className="text-[#7D5E19]">deux cires
                        différentes</span> : 
                    </p>
                    <p>
                        A droite, il s’agit de la cire <span className="text-[#7D5E19]">traditionnelle</span>, utilisée
                        pour les <span className="text-[#7D5E19]"></span>zones sensibles. Elle est plus chaude que les
                        autres cires et permet donc de dilater les pores, ce qui
                        facilite l’arrachage du poil et rend l’<span className="text-[#7D5E19]">épilation plus
                        douce et plus durable</span>.
                    </p>
                    <p>
                        La cire au <span className="text-[#7D5E19]">sucre</span> pour les grandes zones, à gauche, est
                        plus douce qu’une cire à bande classique. Surtout, elle
                        est 100% <span className="text-[#7D5E19]">naturelle</span>, c’est un un véritable caramel.
                    </p>
                    <p>
                        Toutes les prestations d’épilation sont <span className="text-[#7D5E19]">mixtes</span>, exceptés
                ...
                <ul className="text-sm md:text-base">
                    <li className="grid grid-cols-6 gap-8 pb-4">
                        <div className="col-span-5 flex flex-col">
                            <div className="font-medium">Sourcils, lèvres ou menton</div>
                    ...
                    <li className="grid grid-cols-6 gap-8 pb-4">
                        <div className="col-span-5 flex flex-col">
                            <div className="font-medium">Lèvres, menton et sourcils</div>
                    ...
                    <li className="grid grid-cols-6 gap-8 pb-4">
                        <div className="col-span-5 flex flex-col">
                            <div className="font-medium">Maillot semi-intégral ou intégral</div>
                            <div className="font-light">30 minutes</div>
                        </div>
                        <div className="col-span-1 text-right font-medium">
                            25€
                    ...
                    <li className="grid grid-cols-6 gap-8 pb-4">
                        <div className="col-span-5 flex flex-col">
                            <div className="font-medium">Aisselles, maillot simple et demi-jambes</div>
                    ...
                    <li className="grid grid-cols-6 gap-8 pb-4">
                        <div className="col-span-5 flex flex-col">
                            <div className="font-medium">Aisselles, maillot simple et jambes entières</div>
                    ...
                    <li className="grid grid-cols-6 gap-8 pb-4 italic">
                        <div className="col-span-5 flex flex-col">
                            <div className="font-medium">Option maillot échancré</div>
