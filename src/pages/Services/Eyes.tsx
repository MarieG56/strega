        ...
        <div className="container md:flex md:flex-col py-8">
            ...
            <div className="flex mx-auto flex-col md:flex-row gap-15 items-center md:items-start md:pb-8 md:px-30">
                ...
                <div className="md:text-left md:w-3/5 hidden md:flex md:flex-col md:gap-4 pl-15 my-auto text-xl font-medium">
                    <p>
                        Un seul détail peut <span className="text-[#7D5E19]">tout</span> changer. C’est ce que je vous
                        propose avec ces techniques naturelles et non-invasives
                        pour mettre en valeur le regard.
                    </p>
                    <p>
                        Transformez vos <span className="text-[#7D5E19]">sourcils</span> en les épaississant
                        visuellement avec un <span className="text-[#7D5E19]">browlift</span> et/ou en les intensifiant
                        avec une <span className="text-[#7D5E19]">teinture</span>.
                    </p>
                    <p>
                        Intensifiez vos <span className="text-[#7D5E19]">cils</span> avec une teinture et/ou
                        allongez-les avec un <span className="text-[#7D5E19]">rehaussement</span> de cils.
                    </p>
                </div>
            </div>
